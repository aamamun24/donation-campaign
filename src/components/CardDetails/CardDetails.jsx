        ...
        <div>
            <div className='relative'>
                ...
                <div className='absolute w-full h-1/3 md:h-1/6 bg-black bottom-0 bg-opacity-50 flex items-center rounded-b-lg'>
                    <button onClick={handleDonate} className='text-white py-2 lg:py-4 px-4 lg:px-7 rounded text-xl font-medium md:font-bold ml-10' style={{ background: text_button_bg }}>Donate ${price}</button>
                </div>
            </div>
